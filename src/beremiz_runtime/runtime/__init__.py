...
from beremiz_runtime.runtime.Worker import worker
...
def LogMessageAndException(msg, exp=None):
    ...
    if _PLCObjectSingleton is not None:
        _PLCObjectSingleton.LogMessage(
...
def CreatePLCObjectSingleton(*args, **kwargs):
    ...
    from beremiz_runtime.runtime.PLCObject import (  # noqa # pylint: disable=wrong-import-position
        PLCObject,
    )
